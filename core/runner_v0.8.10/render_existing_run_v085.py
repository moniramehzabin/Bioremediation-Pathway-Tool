...
def main():
    ...
    cmd=[sys.executable,str(here/'visual_pathway_reporter_v085.py'),'--db',a.db,'--pathway-summary',str(ps),'--reaction-evidence',str(re),'--out-html',str(out),'--sample-name',a.sample_name or pre]

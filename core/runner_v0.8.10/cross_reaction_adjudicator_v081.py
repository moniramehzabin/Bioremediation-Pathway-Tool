#!/usr/bin/env python3
"""
Cross-reaction locus adjudicator v0.8.1
...
def main():
    ...
    for pid,rows in pgroup.items():
        ...
        cand_units=0; supp_units=0; missing=[]
        observed_rx=set()
        for uname,members in units:
            ...
            for rid in members:
                ...
                supp=truth(rr.get("exact_supported")) and state not in {"CANDIDATE_CONFLICTING","NO_CANDIDATE"}
                if cand:
    ...
    pfields=["pathway_id","pathway_name","required_units","candidate_units","candidate_percent",
             "supported_units","supported_percent","adjudicated_pathway_state",
    ...
    print("Cross-Reaction Adjudicator v0.8.1")
